...
class DataTransformationConfig:
    def __init__(self,train_pipeline_config:TrainPipelineConfig):
        ...
        self.transformed_train_file_path:str = os.path.join(self.data_transformation_dir,train_pipeline.DATA_TRANSFORMATION_TRANSFORMED_DATA_DIR,train_pipeline.TRAIN_FILE_NAME.replace("csv","npy"))

        self.transformed_test_file_path:str = os.path.join(self.data_transformation_dir,train_pipeline.DATA_TRANSFORMATION_TRANSFORMED_DATA_DIR,train_pipeline.TEST_FILE_NAME.replace("csv","npy"))

        self.preprocessed_object_file_path:str = os.path.join(self.data_transformation_dir,train_pipeline.DATA_TRANSFORMATION_TRANSFORMED_OBJECT_DIR,train_pipeline.PREPROCESSING_OBJECT_FILE_NAME.replace("csv","pkl"))   
...
class TrainerModelConfig:
    def __init__(self,train_pipeline_config:TrainPipelineConfig):
        ...
        self.trained_model_file_path:str = os.path.join(self.model_trainer_dir,train_pipeline.MODEL_TRAINER_TRAINED_MODEL_DIR,train_pipeline.MODEL_TRAINER_TRAINED_MODEL_NAME)

        self.expected_accuracy:float = train_pipeline.MODEL_TRANER_EXPECTED_SCORE
        
        self.overfitting_underfitting_threshold:float = train_pipeline.MODEL_TRAINER_OVER_FIITING_UNDER_FITTING_THRESHOLD
